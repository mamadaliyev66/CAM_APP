...
export default function SpeakingLevel({ navigation }) {
  ...
  const parts = [
    { title: 'Speaking Part 1', id: 'Part 1' },
    { title: 'Speaking Part 2', id: 'Part 2' },
    { title: 'Speaking Part 3', id: 'Part 3' },
  ];
    ...
    <PaperProvider theme={customTheme}>
      ...
      >
        <Appbar.Header style={{ backgroundColor: theme.colors.primary }}>
          ...
          <Appbar.Content title="MULTI LEVEL SPEAKING" titleStyle={{ color: theme.colors.onPrimary, fontWeight: 'bold' }} />
        </Appbar.Header>
