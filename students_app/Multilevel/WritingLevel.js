...
export default function WritingLevel({ navigation }) {
  ...
  const parts = [
    { title: 'Writing Task 1', id: 'Task 1' },
    { title: 'Writing Task 2', id: 'Task 2' },
    { title: 'Writing Task 3', id: 'Task 3' },
  ];
    ...
    <PaperProvider theme={customTheme}>
      ...
      >
        <Appbar.Header style={{ backgroundColor: theme.colors.primary }}>
          ...
          <Appbar.Content title="MULTI LEVEL WRITING" titleStyle={{ color: theme.colors.onPrimary, fontWeight: 'bold' }} />
        </Appbar.Header>
