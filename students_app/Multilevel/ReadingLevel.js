...
export default function ReadingLevel({ navigation }) {
  ...
  const parts = [
    ...
    { title: 'Reading Passage 4', id: 'Passage 4' },
    { title: 'Reading Passage 5', id: 'Passage 5' },
  ];
    ...
    <PaperProvider theme={customTheme}>
      ...
      >
        <Appbar.Header style={{ backgroundColor: theme.colors.primary }}>
          ...
          <Appbar.Content title="MULTI LEVEL READING" titleStyle={{ color: theme.colors.onPrimary, fontWeight: 'bold' }} />
        </Appbar.Header>
