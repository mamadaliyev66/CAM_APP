...
export default function ListeningLevel({ navigation }) {
  ...
  const parts = [
    { title: 'Listening Part 1', id: 'Part 1' },
    { title: 'Listening Part 2', id: 'Part 2' },
    { title: 'Listening Part 3', id: 'Part 3' },
    { title: 'Listening Part 4', id: 'Part 4' },
    { title: 'Listening Part 5', id: 'Part 5' },
    { title: 'Listening Part 6', id: 'Part 6' },
  ];
  ...
  const togglePart = (index) => {
    ...
    if (!lessonsByPart[partKey]) {
      ...
      const partDocRef = doc(firestore, 'multilevelMaterials', partTitle);
    ...
    if (loadingPart === part.id) {
      ...
      return lessons.map((item) => (
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate('MaterialsLevel', {
    ...
    <PaperProvider theme={customTheme}>
      ...
      >
        <Appbar.Header style={{ backgroundColor: theme.colors.primary }}>
          ...
          <Appbar.Content title="MULTI LEVEL LISTENING" titleStyle={{ color: theme.colors.onPrimary, fontWeight: 'bold' }} />
        </Appbar.Header>
